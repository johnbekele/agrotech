...
const ProductDetails = ({ machineId }) => {
  ...
  const handleContactOwner = () => {
    if (machine && machine.ownerId && machine.ownerId.mobile) {
      // Create a temporary element to copy phone number
      const tempElement = document.createElement('textarea');
      tempElement.value = machine.ownerId.mobile;
      ...
      alert(`Phone number ${machine.ownerId.mobile} copied to clipboard!`);
    }
  };
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-2xl border-2 border-[#2a7f62]/10">
                ...
                <div className="space-y-3">
                  <button 
                    onClick={openModal}
                    className="w-full bg-gradient-to-r from-[#2a7f62] to-[#41676a] hover:from-[#2f6b57] hover:to-[#4a737a] text-white font-bold py-4 px-6 rounded-xl shadow-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2"
                  >
                    <CalendarToday />
                    Book Now
                  </button>
                  <button 
                    ...
                    className="w-full bg-white hover:bg-gray-50 text-[#2a7f62] border-2 border-[#2a7f62] font-bold py-4 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-2"
                  >
                    <Phone />
                    Contact Owner
                  </button>
      ...
      >
        <div className="bg-white rounded-3xl p-8">
          <div className="flex items-center justify-center gap-3 mb-6">
            <div className='w-12 h-12 bg-gradient-to-br from-[#2a7f62] to-[#41676a] rounded-full flex items-center justify-center shadow-md'>
          ...
          <div className="bg-gray-50 rounded-2xl p-6 mb-6">
            <p className='text-lg mb-4 text-center text-gray-700'>
              Are you sure you want to book <span className="font-bold text-[#2a7f62]">{name}</span>?
            </p>
            
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Price:</span>
                <span className="font-bold text-2xl text-[#2a7f62]">${rentalPrice}/day</span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <input
                  type="date"
                  className="flex-1 border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-[#2a7f62] focus:border-transparent outline-none"
              ...
              <div className="flex justify-between items-center">
                ...
                <span className={`font-semibold ${availability ? 'text-green-600' : 'text-red-600'}`}>
          ...
          <div className='flex justify-center gap-4'>
            <button 
              ...
              className='bg-gradient-to-r from-[#2a7f62] to-[#41676a] hover:from-[#2f6b57] hover:to-[#4a737a] text-white font-bold py-3 px-8 rounded-xl shadow-lg transition-all duration-300 transform hover:scale-105'
            >
              Confirm Booking
            </button>
            <button 
              onClick={closeModal} 
              className='bg-white hover:bg-gray-50 text-gray-700 border-2 border-gray-300 font-bold py-3 px-8 rounded-xl transition-all duration-300'
            >
              Cancel
            </button>
          </div>
